...
?>
<a href="index.php?cmd=edit" class="btn green"><i class="fa fa-plus-circle"></i> Add a <?=ucwords(str_replace("_"," ","company"))?></a> <br><br>
				      ...
				      <div class="table-responsive">	
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                                ...
                                <td>
								   <?php
								      if(is_file('../../'.$arr[$i]['file_company_logo'])
										&& file_exists('../../'.$arr[$i]['file_company_logo']))
										{
								   ?>
								    <img src="../../<?=$arr[$i]['file_company_logo']?>" style="width:100px;">
                                   <?php
										}
								   ?>		
                                </td>
                                <td>
                                    <?php
								      if(is_file('../../'.$arr[$i]['file_report_logo'])
										&& file_exists('../../'.$arr[$i]['file_report_logo']))
										{
								   ?>
								    <img src="../../<?=$arr[$i]['file_report_logo']?>" style="width:100px;">
                                   <?php
										}
								   ?>		
                                </td>
                                <td>
                                    <?php
								      if(is_file('../../'.$arr[$i]['file_report_background'])
										&& file_exists('../../'.$arr[$i]['file_report_background']))
										{
								   ?>
								    <img src="../../<?=$arr[$i]['file_report_background']?>" style="width:100px;">
                                   <?php
										}
								   ?>		
                                </td>
                                <td><?=$arr[$i]['report_footer']?></td>
                                <td nowrap >
