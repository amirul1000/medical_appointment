...
?>
<script language="javascript" src="department.js"></script>
...
<a href="index.php?cmd=list" class="btn green"><i class="fa fa-arrow-circle-left"></i> List</a> <br><br>
  <div class="portlet box blue">
      <div class="portlet-title">
          <div class="caption"><i class="fa fa-globe"></i><b><?=ucwords(str_replace("_"," ","department"))?></b>
          </div>
          <div class="tools">
	                ...
	                <table class="table">
							 <tr>
							  <td>  
								 ...
								 <form name="frm_department" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
								  <div class="portlet-body">
						         <div class="table-responsive">	
					                <table class="table">
										 <tr>
                                             <td>Dept Name</td>
                                             <td>
                                                <input type="text" name="dept_name" id="dept_name"  value="<?=$dept_name?>" class="form-control-static">
                                             </td>
                                         </tr>
                                         <!--<tr>
                                             <td>Created At</td>
