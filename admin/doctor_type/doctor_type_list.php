...
<a href="index.php?cmd=edit" class="btn green"><i class="fa fa-plus-circle"></i> Add a <?=ucwords(str_replace("_"," ","doctor_type"))?></a> <br><br>
 <div class="portlet box blue">
           <div class="portlet-title">
                <div class="caption"><i class="fa fa-globe"></i><b><?=ucwords(str_replace("_"," ","doctor_type"))?></b>
                </div>
                <div class="tools">
	         ...
	         <div class="table-responsive">	
					         ...
					         <div class="table-responsive">	
				                <table align="right">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("doctor_type");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_doctor_type" >
			  ...
			  <td><?=$arr[$i]['fee_amount']?></td>
                              ...
                              <td nowrap >
								  ...
								  <a  href="javascript:void();"  onClick="popUp('index.php?cmd=doctor_type_details&id=<?=$arr[$i]['id']?>')" class="btn blue button-next">
									   Details
