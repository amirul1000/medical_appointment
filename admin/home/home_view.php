<?php
	...
	$name2       = $_SERVER['REQUEST_URI'];
	$b_name_arr  = explode("/",$name2);
	$b_name      = $b_name_arr[count($b_name_arr)-2];
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		<div class="page-logo" style="width:363px;">
            ...
            <label>
             <?php
             if(is_file('../../'.$rescompany[0]['file_company_logo'])&&file_exists('../../'.$rescompany[0]['file_company_logo']))			
				{
			  ?>
              <img src="../../<?=$rescompany[0]['file_company_logo']?>" alt="logo" class="logo-default" style="height:30px;float:left"/> 
              <?php
				}
				else
				{
		     ?>
             <img src="" alt="logo" class="logo-default" style="height:30px;float:left"/>
             <?php			
				}
		    ?>
            <h6 class="heading_text_logo"><?=$rescompany[0]['company_name']?></h6></label>
			</a>
			...
			<!-- BEGIN DASHBOARD STATS -->  
              <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat blue-madison">
						...
						<div class="details">
							<div class="number">
								 <?php
									...
									$info["where"]   = "1";
									$arrcusttotal =  $db->select($info);
									echo $arrcusttotal[0]['total'];
								 ?>
							</div>
							<div class="desc">
								  Department
						...
						<a class="more" href="../department/?cmd=list">
              ...
              <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat green-haze">
						...
						<div class="details">
							<div class="number">
								 <?php
									...
									$info["fields"] = array("count(*) as total"); 
									$info["where"]   = "1";
									$arrinvoicetotal =  $db->select($info);
									echo $arrinvoicetotal[0]['total'];
								 ?>
							</div>
							<div class="desc">
								  Slot
						...
						<a class="more" href="../slot/?cmd=list">
						View more <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat blue-madison">
						...
						<div class="details">
							<div class="number">
								 <?php
									...
									$info["fields"] = array("count(*) as total"); 
									$info["where"]   = "1";
									$arruserstotal =  $db->select($info);
									echo $arruserstotal[0]['total'];
								 ?>
							</div>
							<div class="desc">
								  Users
						...
						<a class="more" href="../users/?cmd=list">
						View more <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
