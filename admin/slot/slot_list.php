...
?>
<a href="index.php?cmd=edit" class="btn green"><i class="fa fa-plus-circle"></i> Add a <?=ucwords(str_replace("_"," ","slot"))?></a> <br><br>
				                ...
				                <table align="right">
									  <TR>
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_slot" >
				   ...
				   <td> 
				      ...
				      <div class="table-responsive">	
						 ...
						 <?php
								...
								$info["where"]   = "1   $whrstr ORDER BY display_order_no ASC  LIMIT $offset, $rowsPerPage";
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
							  <td><?=$arr[$i]['display_order_no']?></td>
                              <td><?=$arr[$i]['slot_time']?></td>
                              <td><?=$arr[$i]['comment']?></td>
                              <td><?=$arr[$i]['status']?></td>			  
							  <td nowrap >
