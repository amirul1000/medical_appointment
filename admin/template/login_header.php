...
<link href="<?=$assets_url?>/assets/admin/pages/css/login.css" rel="stylesheet" type="text/css"/>
...
<link href="<?=$assets_url?>/assets/admin/layout/css/themes/darkblue.css" rel="stylesheet" type="text/css" id="style_color"/>
...
<div class="logo">
	<a href="">
	<img src="../../<?=$rescompany[0]['file_company_logo']?>" alt="" style="width:100px;"/>
	</a>
</div>
<!-- END LOGO -->