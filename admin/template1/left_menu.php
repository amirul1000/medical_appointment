               ...
               <li class="start">
                ...
                <li <?php if(  $b_name=="company" ||  
					...
					<ul class="sub-menu">
                        ...
                        <li <?php if($b_name=="doctor_type") { ?> class="active open" <?php } ?>><a href="../doctor_type/index.php?cmd=list"><i class="icon-rocket"></i>Doctor fee</a></li>
                ...
                <!--<li class="start"><a href="../country/index.php?cmd=list"><i class="icon-rocket"></i>Country</a></li>-->
                    ...
                    <li <?php if($b_name=="book_a_slot") { ?> class="active open" <?php } ?>><a href="../book_a_slot/index.php?cmd=list"><i class="icon-rocket"></i>Book a slot</a></li>
